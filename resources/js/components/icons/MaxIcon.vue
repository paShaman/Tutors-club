<template>
  <svg viewBox="0 0 1000 1000" fill="none" aria-hidden="true">
    <defs>
      <linearGradient id="maxBotIcon" x1="117.847" y1="760.536" x2="1000" y2="500" gradientUnits="userSpaceOnUse">
        <stop stop-color="#4CCFFF" />
        <stop offset="0.662" stop-color="#5533EE" />
        <stop offset="1" stop-color="#9933DD" />
      </linearGradient>
    </defs>
    <rect width="1000" height="1000" rx="249.681" fill="url(#maxBotIcon)" />
    <path
      fill="#fff"
      fill-rule="evenodd"
      clip-rule="evenodd"
