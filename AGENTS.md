...
- Icons: `lucide-vue-next` (every icon used in a template must be imported — an unresolved PascalCase tag renders nothing and only warns in the console). Charts: register ChartJS modules where used. Calendar: `@fullcalendar/vue3`.
